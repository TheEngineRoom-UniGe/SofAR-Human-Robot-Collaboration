...
namespace RosMessageTypes.HumanBaxterCollaboration
{
    ...
    {
        public const string RosMessageName = "human_baxter_collaboration/MoverService";
        ...
        public MoverServiceRequest(BaxterMoveitJoints joints_input, Geometry.Pose pick_pose, Geometry.Pose place_pose)
        {
